export const bookingAbi = [
  ...
  {
    type: "function",
    name: "getBookingsByGuest",
    inputs: [{ name: "guest", type: "address", internalType: "address" }],
    outputs: [
      {
        name: "",
        type: "tuple[]",
  ...
  {
    type: "error",
    name: "HotelBooking__InsufficientContractBalance",
    inputs: [],
  },
  { type: "error", name: "HotelBooking__InsufficientTokenBalance", inputs: [] },
  { type: "error", name: "HotelBooking__InvalidBookingDates", inputs: [] },
  { type: "error", name: "HotelBooking__InvalidRating", inputs: [] },
  { type: "error", name: "HotelBooking__NoAvailableRoom", inputs: [] },
